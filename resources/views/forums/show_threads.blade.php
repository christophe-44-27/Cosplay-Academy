                        ...
                        <tr class="topic">
                            <td>
                                <div class="topic_name">
                                    <a href="{{ route('show_forum_thread', $thread->slug) }}">{{ $thread->title }}</a>
                                </div>
                                <div class="topic_meta">
                                    par {{ $thread->creator->name }}, <span class="js-vue"><abbr
                                            class="timeago">{{ Carbon\Carbon::parse($thread->created_at)->diffForHumans()}}</abbr></span>
                                </div>
                            </td>
                            ...
                            <td class="topic_post tdh">
                                @if(count($thread->lastReply) > 0)
                                    <a class="topic_name" href="{{ route('show_forum_thread', $thread->slug) }}">Par {{ $thread->lastReply->owner->name }}</a>
                                    <div class="topic_meta">
                                        <span class="js-vue">
                                            <abbr class="timeago">
                                                {{ Carbon\Carbon::parse($thread->lastReply->created_at)->diffForHumans()}}
                                            </abbr>
                                        </span>
                                    </div>
                                @else
