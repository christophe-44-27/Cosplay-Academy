...
<div class="wrapper">
    <div class="intro">
        <div class="header-mail">
            ...
            <h2>Demande de revue de tutoriel</h2>
        </div>
        <div class="body-message">
            <h3>Hello Administrateur,</h3>
            <p>
                Le membre <b>{{ $tutorial->user->public_pseudonym }}</b> souhaiterait recevoir une revue du tutoriel intitulé {{ $tutorial->title }}.
            </p>
