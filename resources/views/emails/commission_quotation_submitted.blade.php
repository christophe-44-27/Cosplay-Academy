...
<div class="wrapper">
    <div class="intro">
        ...
        <div class="body-message">
            <h3>Hello {{ $commissionQuotation->commission->user->public_pseudonym }},</h3>

            <p>
                Vous avez reçu une nouvelle soumission pour votre offre intitulée {{ $commissionQuotation->commission->title }}. Allez vite la voir ! :)
            </p>
