...
<div class="wrapper">
    <div class="intro">
        ...
        <div class="body-message">
            <h3>Félicitations {{ $commissionQuotation->user->public_pseudonym }},</h3>
            <p>
                Votre proposition de {{ $commissionQuotation->price }} $ sur l'offre {{ $commissionQuotation->commission->title }} a été
                acceptée !
            </p>

            @if ($answerQuotation)
                <p>
                    L'auteur de l'offre vous a laissé un message, le voici : <b>{{ $answerQuotation }}</b>
                </p>
            @endif

            <p>
                Vous pouvez répondre à l'auteur directement par le biais de ce courriel.
            </p>
