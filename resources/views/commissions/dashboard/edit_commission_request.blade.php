...
@section('content')
    ...
    <!-- DASHBOARD CONTENT -->
        <div class="dashboard-content">
            ...
            {!! Form::open(['url' => route('commission_request_update', $offer), 'enctype' => "multipart/form-data"]) !!}
                ...
                <div class="form-box-item full">
                    ...
                    <div>
                        ...
                        <div class="input-container half">
                            ...
                            {{ Form::text('delivery_location', $offer->delivery_location) }}
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container half">
                            ...
                            {{ Form::text('max_budget', $offer->max_budget) }}
                        </div>
                        <!-- /INPUT CONTAINER -->
                        ...
                        <div class="input-container half">
                            ...
                            {{ Form::date('desired_delivery_date', \Carbon\Carbon::createFromTimeString($offer->desired_delivery_date)) }}
                        </div>

                        <div class="input-container half">
                            <label>Catégorie de l'offreTutorial <small>*</small></label>
                            <select name="category_id">
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}"  @if($category->id == $offer->category->id) selected='selected' @endif >{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="input-container">
                            ...
                            {{ Form::text('description', $offer->description, ['class' => 'tinymce']) }}
                        </div>
                        <!-- /INPUT CONTAINER -->
                    </div>
                </div>
