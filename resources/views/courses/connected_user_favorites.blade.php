                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($favorites as $favorite)
                                                <tr>
                                                        ...
                                                        <div class="media mt-0 mb-0">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="card-item-desc ml-4 p-0 mt-2">
                                                                    <a href="{{ route('course_details', ['course' => $favorite]) }}" class="text-dark"><h4 class="font-weight-semibold">{{ $favorite->title }}</h4></a>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('course_favorite_remove', ['course' => $favorite]) }}" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-original-title="Delete from Wishlist">
                            ...
                            @else
                                <div class="alert alert-info">
                                    @lang("Vous n'avez encore pas de cours en favoris.")
                                </div>
                            @endif
                        </div>
                    </div>
