        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-12 col-md-12">
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <h3 class="card-title">@lang('Les cours que je suis')</h3>
                        </div>
                        <div class="card-body">
                            @if($courses->count() > 0)
                                        ...
                                        <tbody>
                                            @foreach($courses as $course)
                                                <tr>
                                                        ...
                                                        <div class="media mt-0 mb-0">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="card-item-desc ml-4 p-0 mt-2">
                                                                    <a href="{{ route('course_details', ['course' => $course]) }}" class="text-dark"><h4 class="font-weight-semibold">{{ $course->title }}</h4></a>
                                                                    <a href="#"><i class="fa fa-clock-o mr-1"></i> @lang("Publié le ") {{ \Carbon\Carbon::parse($course->created_at)->format('d/m/Y') }}</a><br>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('course_details', ['course' => $course]) }}" class="btn btn-info btn-sm text-white">
                                                            <i class="fa fa-eye"></i> @lang("Voir le cours")
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            @else
                                <div class="alert alert-info">
                                    @lang("Vous n'êtes pas encore inscrit à un cours.")
                                </div>
                            @endif
                        </div>
                    </div>
